...
export declare class CourseServiceImpl implements CourseService {
    ...
    static readonly GET_CONTENT_STATE_KEY_PREFIX = "getContentState";
    static readonly GET_ENROLLED_COURSE_KEY_PREFIX = "enrolledCourses";
    static readonly UPDATE_CONTENT_STATE_KEY_PREFIX = "updateContentState";
    static readonly LAST_READ_CONTENTID_PREFIX = "lastReadContentId";
